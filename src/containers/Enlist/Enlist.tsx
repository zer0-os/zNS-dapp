...
//- Component Imports
import { StepBar, ToggleSection, TextInput, FutureButton, Image } from 'components'
...
const Enlist: React.FC<EnlistProps> = ({ domainId, domainName, minterName, image, onSubmit }) => {
      ...
      <form className={styles.Section}>
        <div style={{ display: 'flex' }}>
          <div className={styles.Inputs}>
            ...
            />
            <span className={styles.Bid}>{Number((bidUsd).toFixed(2)).toLocaleString()} WILD</span>
          </div>
          <div
