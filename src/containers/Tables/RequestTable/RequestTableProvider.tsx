...
export const RequestTableContext = React.createContext({
    ...
    setView: (domain: DomainRequestAndContents | undefined):void=>{return},
    setLoadRequest:(domain:DomainRequestAndContents[]):void=>{return}
...
const RequestTableProvider: React.FC<BidProviderType> = ({ children }) => {
	...
	return (
		<RequestTableContext.Provider value={contextValue}>{children}</RequestTableContext.Provider>
	);
};
