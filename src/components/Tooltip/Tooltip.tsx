...
type TooltipProps = {
	...
	text: string;
	auto?: boolean;
	placement?: 'top-start' | 'top-center' | 'top-end' | 'left-start' | 'left-center' | 'left-end' | 'right-start' | 'right-center' | 'right-end' | 'bottom-start' | 'bottom-center' | 'bottom-end';
...
const Tooltip: React.FC<TooltipProps> = ({
	...
	const [isOver, hoverProps] = useHover({ delayEnter, delayLeave, hideOnScroll });
